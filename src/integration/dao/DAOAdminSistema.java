...
import business.to.TOAdminSistema;
 ...
 */
public class DAOAdminSistema implements DataAccessObject {

    private final Connector connector;
    private final XMLReader xmlReader;

    private final String QUERY_ID = "admin_sistema";
    private final String REGEX;

    public DAOAdminSistema() {
    ...
    private List<TransferObject> readListFromRs(ResultSet rs) {
        ...
        try {
            while (rs.next()) {
                TOAdminSistema adminSistema = (TOAdminSistema) TOFactory.getTO("TOAdminSistema");

                adminSistema.setId(rs.getString("id_adsis"));
                adminSistema.setNome(rs.getString("nome"));
                adminSistema.setCognome(rs.getString("cognome"));
                adminSistema.setEmail(rs.getString("email"));
                adminSistema.setTelefono(rs.getString("telefono"));
                adminSistema.setCitta(rs.getString("citta"));
                adminSistema.setIndirizzo(rs.getString("indirizzo"));
                adminSistema.setCodiceFiscale(rs.getString("codice_fiscale"));

                list.add(adminSistema);
            }
